		...
		return (
			<div className="seats">
				<div>
					...
					<Link to={{pathname: '/book/confirm/', state: {film: this.props.location.state.film, showing: this.props.location.state.showing, seats: this.state.seats, tickets: this.props.location.state.tickets, bookingID: this.props.location.state.bookingID}}}><button type='button' className="confbutton">Confirm Booking</button></Link>
				</div>
			</div>
		);
	}
