...
function placestogo () {
    return (
        ...
        <img className="luigis" src={luigis} style={{height:200, width:300}}></img>
        ...
        <img className="tacobell" src={tacobell} style={{height:200, width:300}}></img>
        ...
        <img className="cinebar" src={cinebar} style={{height:200, width:300}}></img>
        ...
        <img className="oscars" src={oscars} style={{height:200, width:300}}></img>
