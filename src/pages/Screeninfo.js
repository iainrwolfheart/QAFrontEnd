...
import screenonenew from '../assets/screenonenew.png';
import screentwonew from '../assets/screentwonew.png';

function Screeninfo() {
    return (
        <div className="screens">
        <h1 className="screenone">Screen 1</h1>
        <img className="screen1" src={screenonenew} style={{height:400, width:400}}></img>
        ...
        <img className="screen2" src={screentwonew} style={{height:400, width:400}}></img>
